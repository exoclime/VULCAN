...
atm_file = 'atm/atm_GJ1214b_Kzz_aer.txt' # TP and Kzz (optional) file
sflux_file = 'atm/stellar_flux/sflux-GJ1214.txt' #  This is the flux density at the stellar surface
...
use_photo = True
# astronomy input
r_star = 0.216 # stellar radius in solar radius
Rp = 0.24463*7.1492E9 # Planetary radius (cm) (for computing gravity)
orbit_radius = 0.01411 # planet-star distance in A.U.
...
gs = 1065.         # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
...
r_max = 10.0 # Maximum radius of size distribution [um]
