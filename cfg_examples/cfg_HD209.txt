...
atm_file = 'atm/atm_HD209_Kzz.txt' # TP and Kzz (optional) file
...
vul_ini = 'output/HD209-noPhoto.vul' # the file to initialize the abundances for ini_mix = 'vulcan_ini'
# output:
output_dir = 'output/'
plot_dir = 'plot/'
movie_dir = 'plot/movie/'
out_name =  'HD209.vul' # output file name
...
use_photo = True
# astronomy input
r_star = 1.203 # stellar radius in solar radius
Rp = 1.38*7.1492E9 # Planetary radius (cm) (for computing gravity)
...
gs = 936.         # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
