...
plot_EQ = True
output = open('../output/mix_table/EQ-HD189-vulcan.txt', "w")
out_species = ['CH4', 'CO', 'CO2', 'H2', 'H', 'H2O', 'HCN', 'He', 'NH3', 'O2', 'NO', 'OH', 'C2H2']
...
for n, p in enumerate(vul['atm']['pco']):
    ost += '{:<8.3E}'.format(p)  + '{:>8.1f}'.format(vul['atm']['Tco'][n])  + '{:>10.2E}'.format(vul['atm']['zco'][n]) + '{:>10.2E}'.format(vul['atm']['mu'][n])
